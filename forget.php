...
if(isset($_POST['submit']))
{
	...
	if(!$form)
	{
		...
		{
			$sub="Password Change - Erasmith";
			$text='Sir as per requested we are sending you a link to change your password.';
			$text.="You can change the pass by simply clicking <a href='http://erasmith.com/changepass?code=".$x."'>here</a>";
			$headers  = 'MIME-Version: 1.0' . "\r\n";
        	$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
			$headers .= 'From: Admin<no-reply@erasmith.com>' . "\r\n";
...
<html>
<head>
	<title>Erasmith | Forget Password</title>
