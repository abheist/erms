<?php
	...
	if(isset($_POST['submit']))
	{
		...
		$query="select user_id,user_name,user_right,active from user_details where user_email='$email' and user_pass=SHA('$password')";
		...
		if(mysqli_num_rows($result)==1)
		{
			...
			$active=$row['active'];
			if(!$active)
				$error="Your account has been deactivated.Request Superuser to activate your account.";
			else
			{
